...
namespace Task_3
{
    ...
    internal class Program
    {
        ...
        public static string Full_Path_Child()
        {
            ...
            string[] files = Directory.GetFiles(solution, "MyCalc.exe", SearchOption.AllDirectories);
            if (files.Length > 0)
            {
                return files[0];
            }
        ...
        static void Main(string[] args)
        {
           ...
           // Console.WriteLine(result);
            Process p = Process.Start(Full_Path_Child(), result);
            p.WaitForExit();
        }
    }
}
